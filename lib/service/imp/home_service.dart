...
class HomeService extends HomeApi {
  ...
  Future<Clinic> getClinicInformation(String clinicId) async {
    var query = instance.collection('clinics').doc(clinicId).withConverter(
